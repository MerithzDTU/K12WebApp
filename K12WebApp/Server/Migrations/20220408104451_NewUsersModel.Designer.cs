...
namespace K12WebApp.Server.Migrations
{
    ...
    [Migration("20220408104451_NewUsersModel")]
    partial class NewUsersModel
    {
            ...
            modelBuilder.Entity("K12WebApp.Shared.Grocery", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedByUserId = 1,
                            DateCreated = new DateTime(2022, 4, 8, 12, 44, 50, 916, DateTimeKind.Local).AddTicks(7016),
                            GroceryName = "Løg",
                            isBought = false
                        },
                        new
                        {
                            Id = 2,
                            CreatedByUserId = 1,
                            DateCreated = new DateTime(2022, 4, 8, 12, 44, 50, 916, DateTimeKind.Local).AddTicks(7049),
                            GroceryName = "Hvidløg",
                            isBought = false
                        },
                        new
                        {
                            Id = 3,
                            CreatedByUserId = 1,
                            DateCreated = new DateTime(2022, 4, 8, 12, 44, 50, 916, DateTimeKind.Local).AddTicks(7051),
                        ...
                        new
                        {
                            Id = 4,
                            CreatedByUserId = 1,
                            DateCreated = new DateTime(2022, 4, 8, 12, 44, 50, 916, DateTimeKind.Local).AddTicks(7053),
                            GroceryName = "Karry",
                            isBought = false
                        });
                });
